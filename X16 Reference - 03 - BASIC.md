...
20 FOR X=1 TO 1000 : NEXT X : REM DELAYS FOR A BIT
30 FMNOTE 1,0 : REM RELEASES THE NOTE
40 FMNOTE 1,$3A : REM PLAYS A IN THE 3RD OCTAVE
50 FOR X=1 TO 500 : NEXT X : REM SHORT DELAY
60 FMNOTE 1,-$3B : REM GLIDES UP A HALF STEP TO A#
70 FOR X=1 TO 500 : NEXT X : REM SHORT DELAY
80 FMNOTE 1,0 : REM RELEASES THE NOTE
```
...
The full set of macros are documented [here](X16%20Reference%20-%20Appendix%20A%20-%20Sound.md#basic-fmplay-and-psgplay-string-macros).
...
40 FMPLAY 1,"G8AGFE4C G8AGFE4C" : REM THIRD LINE
...
40 FOR X=1 TO 500 : NEXT X : REM SHORT DELAY
50 PSGNOTE 1,$3A : REM PLAYS A IN THE 3RD OCTAVE
60 FOR X=1 TO 500 : NEXT X : REM SHORT DELAY
...
20 PSGPLAY 0,"T240 O5 L16" : REM TEMPO 240 BPM, 5TH OCTAVE, 16TH NOTES
30 PSGPLAY 0,"C<G>CEG>C<G<A-"
40 PSGPLAY 0,">CE-A-E-A->CE-A-"
50 PSGPLAY 0,"E-<<B->DFB-FB->DFA-F" : REM GRAB YOURSELF A MUSHROOM
```
