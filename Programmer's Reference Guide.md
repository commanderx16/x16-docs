...
See [vera-module v0.7.pdf](https://github.com/commanderx16/x16-docs/blob/master/vera-module%20v0.7.pdf) for the complete reference. Please note that the layout of registers is far from finalized.
