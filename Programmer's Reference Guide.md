...
See [vera-module v0.6.pdf](https://github.com/commanderx16/x16-docs/blob/master/vera-module%20v0.6.pdf) for the complete reference. Please note that the layout of registers is far from finalized.
