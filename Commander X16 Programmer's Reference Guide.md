...
|-----------|---------------------------------------------------------------------|
|$0000-$0399|System Reserved (see RAM Contents section)                           |
|$0400-$9EFF|Low RAM (36 KB minus 256 bytes)                                      |
...
**Note: There is no continuous memory from $0000 till $BFFF in the commander X16 available for prg files:**

- Due to the I/O area located at $9F00 till $9FFF.
- RAM bank 0 is system reserved, so at system startup, RAM bank 1 is configured by default for the user.
...
|Addresses  |Description                                                     |
|-----------|----------------------------------------------------------------|
|$0000-$00FF|Zero page (See Zero Page section)                               |
|$0100-$01FF|CPU stack                                                       |
...
Zero page is used extensively in the commander X16:  

|Addresses  |Description                            |Recommendations for assembler programmers                      |
|-----------|---------------------------------------|---------------------------------------------------------------|
|$0000-$0001|Banking registers                      |Set ROM and RAM banks                                          |
|$0002-$0021|16 bit registers r0-r15 for KERNAL API |Can be used, but with dependency to API calls, use with care!  |
|$0022-$007F|Available to the user                  |Free                                                           |
|$0080-$009C|Used by KERNAL and DOS                 |System Reserved                                                |
|$009D-$00A8|Reserved for DOS/BASIC                 |System Reserved                                                |
|$00A9-$00D3|Used by the Math library (and BASIC)   |Can be used if no floating point math and/or basic             |
|$00D4-$00FF|Used by BASIC                          |Can be used if no basic                                        |

#### Banking

This is the allocation of banked RAM in the KERNAL/BASIC environment.

|Bank |Description                                 |Recommendation for assembler programmers                       |
|-----|--------------------------------------------|---------------------------------------------------------------|
|0    |Used for KERNAL/CBDOS variables and buffers |System Reserved, **don't use!**                                |
|1-255|Available to the user                       |Free                                                           |
